...
export default function FerryOperators() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 w-full">
      {/* Header */}
     <header className="mx-auto px-4 lg:px-24 py-4 bg-white border-b border-gray-200">
  <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
    {/* Left Side - Title */}
    <div>
      <div className="text-sm text-gray-500 mb-1">
        <span className="text-cyan-500">Ferrytickets</span> &gt; Operators
      </div>
    ...
    <div className="flex flex-wrap gap-2 items-center">
      <button className="flex items-center border px-4 py-2 rounded-md text-sm hover:bg-gray-50">
        <FiFilter className="mr-2" /> Filters
      </button>

      {/* Custom Sort Dropdown */}
      <div className="relative">
        <select className="appearance-none border px-4 py-2 rounded-md text-sm pr-8">
      ...
      <div className="flex items-center border rounded-md px-2">
        ...
        <input
          type="text"
          placeholder="Search"
          className="outline-none p-1 text-sm ml-2 w-32"
        />
      </div>

      {/* Book Tickets Button (Styled like screenshot) */}
      <button className="relative inline-flex items-center px-5 py-2 text-sm font-medium text-white bg-cyan-500 rounded-md shadow focus:outline-none">
      ...
      <main className="p-4 mx-auto px-4 lg:px-24 py-6">
        <div className="flex flex-col lg:flex-row gap-4 mb-8">
          {/* Filter Box */}
          <div className="w-full sm:w-1/2 lg:w-1/4 p-4 bg-white border border-gray-200 rounded-md">
              ...
              <div key={i} className="p-4 bg-white border border-gray-200 rounded-md flex flex-col md:flex-row md:justify-between">
                <div className="flex flex-col md:flex-row md:w-full">
                  ...
                  <div className="ml-4 flex-1">
                    ...
                    <a href="#" className="text-cyan-600 text-sm font-medium mt-1 inline-block">{op.linkText}</a>
                  </div>
                </div>
              </div>
            ))}
