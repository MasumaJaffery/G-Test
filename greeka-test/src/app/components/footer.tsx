              ...
              <div>
                ...
                <div className="flex">
                  <input 
                    ...
                    className="px-4 py-2 rounded-l text-gray-900 w-full bg-white"
                  />
                  <button className="bg-yellow-400 text-gray-900 px-4 py-2 rounded-r font-medium hover:bg-yellow-500">
                    Subscribe
                  </button>
                </div>
              </div>
